class ListingsController < ApplicationController
  ...
  before_action :set_listing, only: [:update, :basics, :description, :address, :price, :photos, :calendar, :bankaccount]
  ...
  def create
    ...
    if @listing.save
      ...
      redirect_to edit_listing_path(@listing), notice: "リスティングを作成・保存できませんでした"
    end
